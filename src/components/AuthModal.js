...
const AuthModal = ({ isOpen, onClose, initialMode = 'login' }) => {
  ...
  const handleGoogleAuth = async () => {
    if (isDevelopmentMode) {
      alert('Google authentication submitted! (Development mode)');
      onClose();
      return;
    }
        ...
        <div className="bg-gradient-to-br from-zinc-900 via-zinc-800 to-zinc-900 rounded-3xl flex overflow-hidden">
          ...
          <div className="w-full md:w-1/2 p-8 relative">
            ...
            <button
              ...
              disabled={isLoading}
              className="w-full bg-white hover:bg-gray-50 text-gray-900 py-3 px-4 rounded-xl font-semibold transition-colors disabled:opacity-50 flex items-center justify-center space-x-3 mb-6"
            >
            ...
            <div className="relative mb-6">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-2 bg-gradient-to-br from-zinc-900 via-zinc-800 to-zinc-900 text-gray-400">Or continue with email</span>
              </div>
            </div>
